document.addEventListener("DOMContentLoaded", function () {
  ...
  const mobileSections = document.querySelectorAll(".mobile-scroll-mt-section");
  ...
  function initializeSwipers() {
    ...
    setTimeout(() => {
      ...
      if (currentIsMobile) {
        window.mobileThumbsSwiper = new Swiper(`${prefix} .thumbs-swiper`, {
          spaceBetween: 8,
          slidesPerView: 4,
          watchSlidesProgress: true,
          freeMode: true,
        ...
        // Desktop swipers
        window.desktopThumbsSwiper = new Swiper(`${prefix} .thumbs-swiper`, {
          spaceBetween: 10,
          slidesPerView: 6,
          watchSlidesProgress: true,
          observer: true,
        ...
        window.desktopMainSwiper = new Swiper(`${prefix} .main-swiper`, {
          spaceBetween: 10,
          thumbs: {
